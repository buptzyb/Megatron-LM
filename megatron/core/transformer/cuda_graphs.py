        ...
        for chunk_id in order:
            ...
            if chunk_id > 0:
                ...
                for per_callable_fwd_idx in fwd_sample_idx:
                    ...
                    if id(layer) not in layer_inputs_signature_cache:
                        ...
                        layer_inputs_signature_cache[id(layer)] = sample_keys
                    else:
                        sample_keys = layer_inputs_signature_cache[id(layer)]
                    ...
                    if consumed_sample_queue.get(sample_keys, []):
                        ...
                        # forward pass, because they are of the same input signature.
